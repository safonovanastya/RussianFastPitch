...
: ${BATCH_SIZE:=16}
: ${GRAD_ACCUMULATION:=4}
: ${OUTPUT_DIR:="./output_fastpitch"}
: ${LOG_FILE:=$OUTPUT_DIR/nvlog.json}
: ${DATASET_PATH:=RUSLAN}
: ${TRAIN_FILELIST:=filelists/short_pitch_ruslan_train.txt}
: ${VAL_FILELIST:=filelists/short_pitch_ruslan_val.txt}
: ${AMP:=false}
: ${SEED:=""}
